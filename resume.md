...
처음에는 하드웨어를 처름 다뤄보는 터라 어려움이 있었습니다.  제가 알고있는 지식을 다른 사람에게 전달해야하기 때문에 기초부터 응용하여 아두이노보드와 센서를 구성할 수 있도록 스터기를 진행하였습니다. 처음 다루는 센서는 구글링을 통하여 사용 방법을 찾아보고 사용법을 응용하여 다른 센서와 연동시키며 학습하였습니다. 
